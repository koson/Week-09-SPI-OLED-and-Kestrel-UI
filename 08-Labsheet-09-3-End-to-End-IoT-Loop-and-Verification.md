...
| :---: | :---: | :---: | :---: | :---: | :---: |
| หมุนซ้ายสุด ($0^\circ$) |0000|0%|0%| [✔️] ตรง [ ] ไม่ตรง |TEST OK|
| หมุนประมาณ $45^\circ$ |1023|23%|23.9%| [✔️] ตรง [ ] ไม่ตรง |TEST OK|
| กึ่งกลาง ($90^\circ$) |2048|50%|49.9%| [✔️] ตรง [ ] ไม่ตรง |TEST OK|
| หมุนประมาณ $135^\circ$|3071|77%|77.2%| [✔️] ตรง [ ] ไม่ตรง |TEST OK|
...
ตอบ น่าจะเป็น UART 115200 bps เพราะส่งข้อมูลได้ช้ากว่า SPI 10 MHz มาก โดย SPI ส่งได้ประมาณ 10 Mbit/s แต่ UART ได้ประมาณ 115.2 kbit/s ดังนั้นถ้าข้อมูลต้องส่งผ่าน Serial จำนวนมาก UART จะเป็นคอขวดมากกว่า ส่วน ADC One-Shot ใช้เวลาอ่านค่าน้อยเมื่อเทียบกับการสื่อสาร
...
ตอบ เพราะถ้า Kestrel หรือเครือข่ายขาดหาย ระบบยังสามารถ ประมวลผลที่ ESP32 เองได้ทันที ทำให้ระบบยังทำงานต่อและตอบสนองได้ หากไม่มีระบบนี้ อุปกรณ์อาจรอเซิร์ฟเวอร์จนเกิดความล่าช้าหรือหยุดทำงานได้
...
ตอบ เพราะ ADC2 ถูกใช้ร่วมกับวงจร Wi-Fi ภายใน ESP32 เมื่อเปิด Wi-Fi แล้วอาจไม่สามารถอ่าน ADC2 ได้ตามปกติ ทำให้ค่า ADC เพี้ยนหรือเกิดปัญหาได้ จึงเลือกใช้ ADC1 เช่น GPIO34 สำหรับอ่าน Potentiometer แทน
